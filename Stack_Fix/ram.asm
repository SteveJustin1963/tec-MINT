...
rStack:        
            ...
            DS DSIZE
DSTACK:      ; MINT interpreter data stack (software managed)
CPUSTACK_DEF: EQU CPUSTACK  ; CPU hardware stack (reference only)
STACK:      EQU CPUSTACK    ; Alias for compatibility
