...
function s = bitwise_and(s)
  ...
  if state.int_mode
    ...
    if state.int_bits == 8
      result = bitand(bitand(int64(a), 255), bitand(int64(b), 255));
    elseif state.int_bits == 16
      result = bitand(bitand(int64(a), 65535), bitand(int64(b), 65535));
    elseif state.int_bits == 32
      result = bitand(bitand(int64(a), 4294967295), bitand(int64(b), 4294967295));
    else  ## 64-bit
...
function s = bitwise_or(s)
  ...
  if state.int_mode
    ## INTEGER MODE: Mask according to bit width
    if state.int_bits == 8
      a_masked = bitand(int64(a), 255);
      b_masked = bitand(int64(b), 255);
      result = bitor(a_masked, b_masked);
    elseif state.int_bits == 16
      a_masked = bitand(int64(a), 65535);
      b_masked = bitand(int64(b), 65535);
      result = bitor(a_masked, b_masked);
    elseif state.int_bits == 32
      a_masked = bitand(int64(a), 4294967295);
      b_masked = bitand(int64(b), 4294967295);
      result = bitor(a_masked, b_masked);
    else  ## 64-bit
...
function s = bitwise_not(s)
  ...
  if state.int_mode
    ...
    if state.int_bits == 8
      a_masked = bitand(int64(a), 255);
      result = bitxor(a_masked, int64(255));
    elseif state.int_bits == 16
      a_masked = bitand(int64(a), 65535);
      result = bitxor(a_masked, int64(65535));
    elseif state.int_bits == 32
      a_masked = bitand(int64(a), 4294967295);
      result = bitxor(a_masked, int64(4294967295));
    else  ## 64-bit
      result = bitxor(int64(a), int64(18446744073709551615));  ## 2^64-1
    endif
  else
    ## FLOATING-POINT MODE: Full 64-bit operation
    result = bitxor(int64(a), int64(18446744073709551615));  ## 2^64-1
...
function s = shift_left(s)
  ...
  if state.int_mode
    ...
    if state.int_bits == 8
      a_masked = bitand(int64(a), 255);
      result = bitand(bitshift(a_masked, 1), 255);
    elseif state.int_bits == 16
      a_masked = bitand(int64(a), 65535);
      result = bitand(bitshift(a_masked, 1), 65535);
    elseif state.int_bits == 32
      a_masked = bitand(int64(a), 4294967295);
      result = bitand(bitshift(a_masked, 1), 4294967295);
    else  ## 64-bit
