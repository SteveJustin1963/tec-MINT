...
# Down to business...
- Its a small fast [Forth](https://en.wikipedia.org/wiki/Forth_(programming_language)) like system meant especially for the TEC-1 prototype and its lesser copies rev A B C D (E F ?) G and if all else fails for gods sake please use the SCC 
