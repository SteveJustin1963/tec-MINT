...
# Down to business...
- A small and fast [Forth](https://en.wikipedia.org/wiki/Forth_(programming_language)) like system for the TEC-1A B C D (E F ?) G and if all else fails for gods sake please use the SCC 
