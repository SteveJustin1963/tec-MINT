...
**Ah, right then, gather 'round, ye code-crunching wizards! You must read my excessively scribbled-upon, over-explained, and possibly bewildering edition of the "[MINT Programming Language Manual V2](https://github.com/SteveJustin1963/tec-MINT/blob/main/SJ%20Manual%20Mint%20V2.md)", now with 67% more footnotes and unnecessary asides. When done try and code some wild and mysterious code fragments and give them a good ol' "smoke test"— which, in this case, may or may not involve a few questionable items of dubious legality. As the test progresses, you’ll inevitably amass a sizeable collection of nuts — so be sure they’re good and crispy! Next, tie up those nuts of yours (but not too tightly) into neat little functions — label them with :A, :B, and so on, until your nuts are firmly in place so not one dares to escape form use. And now, the pièce de résistance: take a deep breath, fling your functions around like a fish monger upon their glorious unification shouting with confidence “This piece of halibut would be good enough for Jehovah!” Voilà! You've now written and used MINT code for God knows what.**
